...
export const newsEvents: TNewsEvent[] = [
  ...
  },
  {
    ...
    description:
      "Successfully showcased our product range at the 14th edition of the expo.",
    date: "August 31, 2023",
    thumbnail:
      "https://images.unsplash.com/photo-1511578314322-379afb476865?q=80&w=1200",
    category: "Event",
    details: {
      title: "Rivar Trims Limited at the 14th Dhaka Yarn & Fabric Show",
      description: `
  ...
  },
  {
    ...
    description:
      "Rivar Trims Limited has obtained the GRS certification, reinforcing our commitment to sustainability.",
