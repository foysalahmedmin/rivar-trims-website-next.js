        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="order-1 lg:order-2">
            <SectionTitle>
              ...
              <Description>
                <p>
                  Rivar Trims Limited Limited is one of the leading
                  conglomerates in the Bangladesh Garment Industry. Established
                  to serve as a complete backward linkage solution, we
                  specialize in high-quality garment accessories including woven
                  labels, printed labels, heat transfers, and packaging
                  solutions.
                </p>
                <p className="mt-4">
